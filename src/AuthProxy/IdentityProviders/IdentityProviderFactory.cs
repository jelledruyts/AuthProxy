...
public class IdentityProviderFactory
{
    ...
    {
        return Defaults.LoginPath; // TODO-C: Make this configurable.
    }
    ...
    {
        return Defaults.LoginCallbackPath; // TODO-C: Make this configurable.
    }
    ...
    private string GetPath(string defaultPath, string? identityProviderPath, string identityProviderName)
    {
        ...
        {
            // TODO-L: Support a replacement pattern in the default path,
